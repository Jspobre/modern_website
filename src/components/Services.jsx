              ...
              />
                      <div className="relative">
                          ...
                          xl:h-[46rem]">
                                ...
                                md:w-3/5 xl:w-auto">
                                  <img src={service1} alt="Smartest AI" className="w-full h-full object-cover
                                  md:object-right" width={800} height={730}/>
                                </div>
                                ...
                                <Generating className="absolute left-4 right-4 bottom-4 border-n-1/10 border
                                  lg:left-1/2 lg:-right-auto lg:-translate-x-1/2 max-md:left-18"/>
                          </div>
